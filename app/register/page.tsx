...
export default function RegisterPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 bg-stone-200 border border-blue-200 rounded-lg shadow-sm text-black" >
      ...
      {state?.success && (
        <div className="mb-4 p-3 bg-green-100 border border-green-300 text-green-700 rounded-lg text-sm font-medium text-center">
          Registrierung erfolgreich! Du kannst dich jetzt einloggen.
        </div>
      )}
      
      
      <form action={formAction} autoComplete="off" className="flex flex-col gap-[15px]">
        <input 
          name="username" 
          type="text" 
